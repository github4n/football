package com.visolink.service.system.dictionaries;
...
public class DictionariesService{
	...
	public List<PageData> getListByParentBianma(PageData pd) throws Exception{
		return (List<PageData>) dao.findForList("DictionariesMapper.getListByParentBianma", pd);
	}
