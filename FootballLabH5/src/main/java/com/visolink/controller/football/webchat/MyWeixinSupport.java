 ...
 * @since 1.1
 */
public abstract class MyWeixinSupport {

    private static final Logger LOG  = LoggerFactory.getLogger(MyWeixinSupport.class);
    //充当锁
    ...
    public String processRequest(HttpServletRequest request) {
        ...
        if (msgType.equals(ReqType.EVENT)) {
            ...
            if (eventType.equals(EventType.SUBSCRIBE)) {
                ...
                if (qrCodeEvent != null) {
                    msg = handleSubscribeQr(qrCodeEvent);
                } else {
