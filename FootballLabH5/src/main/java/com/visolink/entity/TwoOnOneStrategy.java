 ...
 *
 */
public class TwoOnOneStrategy {

	    private String two_on_one_id;
		...
		public String getTwo_on_one_id() {
			return two_on_one_id;
		}

		public void setTwo_on_one_id(String two_on_one_id) {
			this.two_on_one_id = two_on_one_id;
		}
