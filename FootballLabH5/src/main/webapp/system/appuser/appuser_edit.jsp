...
<script type="text/javascript">
	...
	function hasU(){
		...
		var url = "<%=basePath%>happuser/hasU?USERNAME="+USERNAME+"&tm="+new Date().getTime();
	...
	function hasE(USERNAME){
		var EMAIL = $("#EMAIL").val();
		var url = "<%=basePath%>happuser/hasE?EMAIL="+EMAIL+"&USERNAME="+USERNAME+"&tm="+new Date().getTime();
		$.get(url,function(data){
			if(data=="error"){
	...
	function hasN(USERNAME){
		...
		var url = "<%=basePath%>happuser/hasN?NUMBER="+NUMBER+"&USERNAME="+USERNAME+"&tm="+new Date().getTime();
		$.get(url,function(data){
			if(data=="error"){
