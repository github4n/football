...
<body>
	<form action="wxQrcode/${msg }" name="Form" id="Form" method="post">
		...
		<table>
			...
			<tr>
			<td>所属专家：
						<select name = "fk_experts_id" id="fk_experts_id" >
			...
			<tr>
				<td>渠道名称：<input type="text" name="name" id="name" value="${pd.name}" maxlength="32" placeholder="这里输入渠道名称" title="渠道名称"/></td>
			</tr>
			<tr>
