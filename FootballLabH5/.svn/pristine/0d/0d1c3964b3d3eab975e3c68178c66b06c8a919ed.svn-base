package com.visolink.controller.system.head;
...
import com.visolink.service.system.appuser.AppuserService;
import com.visolink.service.system.user.UserService;
import com.visolink.util.AppUtil;
import com.visolink.util.Const;
import com.visolink.util.PageData;
import com.visolink.util.SmsUtil;
import com.visolink.util.Tools;
import com.visolink.util.Watermark;
import com.visolink.util.mail.SimpleMailSender;
...
public class HeadController extends BaseController {
	...
	public Object sendEmail(){
		...
		String strEMAIL = Const.EMAIL;		//读取邮件配置
	...
	public ModelAndView goEditEmail() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd.put("YSYNAME", Const.SYSNAME);	//读取系统名称
		pd.put("COUNTPAGE", Const.PAGE);		//读取每页条数
		String strEMAIL = Const.EMAIL;		//读取邮件配置
		String strSMS1 = Const.SMS1;			//读取短信1配置
		String strSMS2 = Const.SMS2;			//读取短信2配置
		String strFWATERM = Const.FWATERM;	//读取文字水印配置
		String strIWATERM = Const.IWATERM;	//读取图片水印配置
		pd.put("Token", Const.WEIXIN);		//读取微信配置
